...
//go:generate mockgen -destination=mocks/runtime.go -package mocks github.com/dojimanetwork/gossamer/lib/runtime Instance
//go:generate mockgen -destination=mocks/network.go -package mocks github.com/dojimanetwork/gossamer/dot/core Network
